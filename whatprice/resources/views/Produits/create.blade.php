...
<html lang="en">
<head>
	<title>WhatPrice | Ajouter un produit</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-contact100">
		<div class="fond" style="background-color: #2586b5">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "serie is required ">
					...
					<input class="input100" type="text" name="serie" placeholder="ex: Iphone 6S plus ,galaxy s7 edge ,canon cx,..">
					<span class="focus-input100"></span>
				</div>
