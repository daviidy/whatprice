...
<footer class="probootstrap-footer probootstrap-bg" style="background-image: url(img/slider_3.jpg)">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <div class="probootstrap-footer-widget text-left">
          <h4 class="heading">A propos</h4>
          <p>Whatprice est une application développée par la startup Rikudo Technologies.</p>
          <a href="http://rikudotech.com/" class="btn btn-sm btn-primary">Découvrir Rikudo Technologies</a>
      </div>
      </div>
      
      <div class="col-md-5">
        <div class="probootstrap-footer-widget probootstrap-link-wrap">
          <h4 class="heading">Vous souhaitez recevoir des offres exclusives ?</h4>
          <p>Inscrivez-vous à notre newsletter !</p>
          <form action="#">
            <div class="form-field">
              <input type="text" class="form-control" placeholder="Entrer votre adresse E-mail">
              <button class="btn btn-subscribe">S'inscrire</button>
            </div>
          </form>
        </div>
      </div>
