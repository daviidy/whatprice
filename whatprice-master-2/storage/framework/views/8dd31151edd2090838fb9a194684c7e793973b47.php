    ...
    <div class="container">
        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            <li class="<?php echo e(Request::path() == 'home' ? 'active' : ""); ?>"><a href="/">Accueil</a></li>
            <li class="dropdown <?php echo e(Request::path() == 'produits.index' ? 'active' : ""); ?>">
              <a href="#" data-toggle="dropdown">
                Produits
              </a>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo e(route('produits.create')); ?>">Créer un produit</a><br>
                <a class="dropdown-item" href="<?php echo e(route('produits.index')); ?>">Voir la liste des produits</a>
              </div>
            </li>
            <li class="dropdown <?php echo e(Request::path() == 'magasins.index' ? 'active' : ""); ?>">
              <a href="#" data-toggle="dropdown">
                Magasins
              </a>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo e(route('magasins.create')); ?>">Créer un magasin</a><br>
                <a class="dropdown-item" href="<?php echo e(route('magasins.index')); ?>">Voir la liste des magasins</a>
              </div>
            </li>
            <li class="dropdown <?php echo e(Request::path() == 'categories.index' ? 'active' : ""); ?>">
              <a href="#" data-toggle="dropdown">
                  Catégories
              </a>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo e(route('categories.create')); ?>">Créer une catégorie</a><br>
                <a class="dropdown-item" href="<?php echo e(route('categories.index')); ?>">Voir la liste des catégories</a>
              </div>
            </li>
            <li class="<?php echo e(Request::path() == 'contact' ? 'active' : ""); ?>"><a href="/contact">Travaillez avec nous</a></li>
          </ul>
